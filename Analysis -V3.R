...
google.trends_NY_19_1 = gtrends(c("movies to watch","tv shows to watch","shows to binge watch"),geo = c("US-NY-501"),gprop = "web", time = "2019-01-01 2019-07-31")[[1]]
...
google.trends_NY<-plyr::rename(google.trends_NY, c("movies to watch_US-NY-501"="movies to watch", "tv shows to watch_US-NY-501"="tv shows to watch","shows to binge watch_US-NY-501" = "shows to binge watch"))
...
google.trends_IL_19_1 = gtrends(c("movies to watch","tv shows to watch","shows to binge watch"),geo = c("US-IL-602"),gprop = "web", time = "2019-01-01 2019-07-31")[[1]]
...
google.trends_IL<-plyr::rename(google.trends_IL, c("movies to watch_US-IL-602"="movies to watch", "tv shows to watch_US-IL-602"="tv shows to watch","shows to binge watch_US-IL-602" = "shows to binge watch"))
...
google.trends_CO_19_1 = gtrends(c("movies to watch","tv shows to watch","shows to binge watch"),geo = c("US-CO-751"),gprop = "web", time = "2019-01-01 2019-07-31")[[1]]
...
google.trends_CO<-plyr::rename(google.trends_CO, c("movies to watch_US-CO-751"="movies to watch", "tv shows to watch_US-CO-751"="tv shows to watch","shows to binge watch_US-CO-751" = "shows to binge watch"))
...
google.trends_TX_19_1 = gtrends(c("movies to watch","tv shows to watch","shows to binge watch"),geo = c("US-TX-623"),gprop = "web", time = "2019-01-01 2019-07-31")[[1]]
...
google.trends_TX<-plyr::rename(google.trends_TX, c("movies to watch_US-TX-623"="movies to watch", "tv shows to watch_US-TX-623"="tv shows to watch","shows to binge watch_US-TX-623" = "shows to binge watch"))
...
google.trends_WA_19_1 = gtrends(c("movies to watch","tv shows to watch","shows to binge watch"),geo = c("US-WA-819"),gprop = "web", time = "2019-01-01 2019-07-31")[[1]]
...
google.trends_WA<-plyr::rename(google.trends_WA, c("movies to watch_US-WA-819"="movies to watch", "tv shows to watch_US-WA-819"="tv shows to watch","shows to binge watch_US-WA-819" = "shows to binge watch"))
